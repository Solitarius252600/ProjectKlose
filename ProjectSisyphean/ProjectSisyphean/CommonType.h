...
typedef struct UVCoord {
	...
	XMFLOAT2 v3 = { 1, 1 };	//! 頂点3
	XMFLOAT2 v4 = { 1, 0 };	//! 頂点4
	UVCoord(XMFLOAT2 v1_, XMFLOAT2 v2_, XMFLOAT2 v3_, XMFLOAT2 v4_){
		v1 = v1_;
		v2 = v2_;
		v3 = v3_;
		v4 = v4_;
...
struct Position
{
	...
	void setup(XMFLOAT_X pos_, FLOAT pitchDegree_, FLOAT yawDegree_, FLOAT rollDegree_, FLOAT scale_)
	{
		pos		= pos_;
		pitch	= pitchDegree_;
		yaw		= yawDegree_;
